...
export const NIGERIA_LGAS = {
  ...
  'Akwa Ibom': [
    ...
    'Ika', 'Ikono', 'Ikot Abasi', 'Ini', 'Itu', 'Mbo', 'Mkpat-Enin',
  ...
  'Jigawa': [
    'Auyo', 'Babura', 'Biriniwa', 'Birnin Kudu', 'Buji', 'Dutse', 'Garki',
    'Gagarawa', 'Gumel', 'Guri', 'Gwaram', 'Gwiwa', 'Hadejia', 'Jahun',
  ...
  'Katsina': [
    ...
    'Dandume', 'Danja', 'Dan Musa', 'Dutsin Ma', 'Faskari', 'Funtua',
    'Ingawa', 'Jibia', 'Kafur', 'Kaita', 'Kankara', 'Kankia', 'Katsina',
    'Kurfi', 'Kusada', 'Mai\'Adua', 'Mani', 'Mashi', 'Matazu', 'Musawa',
    'Rimi', 'Sabuwa', 'Safana', 'Sandamu', 'Zango'
  ],
  'Kebbi': [
    'Aleiro', 'Arewa Dandi', 'Argungu', 'Augie', 'Bagudo', 'Bunza',
    'Dandi', 'Fakai', 'Gwandu', 'Jega', 'Kalgo', 'Koko/Besse',
  ...
  'Yobe': [
    'Bade', 'Bursari', 'Geidam', 'Gujba', 'Gulani', 'Fika', 'Fune',
    'Jakusko', 'Karasuwa', 'Machina', 'Nangere', 'Potiskum', 'Tarmuwa',
    'Yunusari', 'Yusufari'
  ],
  'Zamfara': [
    'Anka', 'Bakura', 'Birnin Magaji/Kiyaw', 'Bukkuyum', 'Bungudu',
    'Gummi', 'Gusau', 'Kankara', 'Maradun', 'Maru', 'Shinkafi', 'Talata Mafara',
    'Chafe', 'Zurmi'
  ]
}
...
export const getLGAs = (state: string): string[] => {
  return NIGERIA_LGAS[state as keyof typeof NIGERIA_LGAS] || []
}
