          ...
          <View className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <View className="space-y-4">
              ...
              <View className="flex-row justify-between items-center py-3 border-b border-gray-100">
                ...
                <Text className="font-NunitoBold text-gray-900">Oga Mechanic Rider Wallet</Text>
              </View>
              
              <View className="flex-row justify-between items-center py-3">
                <Text className="text-gray-600">Reference</Text>
                <Text className="font-NunitoBold text-gray-900">RIDER-{Date.now()}</Text>
              </View>
            </View>
...
export default RiderBankTransfer;
