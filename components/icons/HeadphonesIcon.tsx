...
import Svg, { Path, NumberProp, SvgProps } from 'react-native-svg';

interface HeadphonesIconProps extends SvgProps {
  size?: number;
  color?: ColorValue;
}
...
export const HeadphonesIcon: React.FC<HeadphonesIconProps> = ({ 
  ...
  return (
    <Svg width={svgWidth} height={svgHeight} viewBox="0 0 24 24" fill="none" {...props}>
      <Path 
